<x-layouts.app>
    ...
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('admin.contacts.index') }}"
            ...
            &larr; {{ __('Back to Contacts Details') }}
        </a>
    </div>
        ...
        <div
            ...
            <div class="space-y-4">
                <div class="flex justify-between">
                    ...
                    <span class="text-gray-800 dark:text-gray-100">{{ $contact->name }}</span>
                </div>

                <div class="flex justify-between">
                    <span class="font-medium text-gray-600 dark:text-gray-400">{{ __('Email') }}</span>
                    <span class="text-gray-800 dark:text-gray-100">{{ $contact->email }}</span>
                </div>

                <div class="flex justify-between">
                    <span class="font-medium text-gray-600 dark:text-gray-400">{{ __('Message') }}</span>
                    <span class="text-gray-800 dark:text-gray-100">{{ $contact->message }}</span>
                </div>

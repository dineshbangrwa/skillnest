        ...
        <nav class="flex-1 overflow-y-auto custom-scrollbar py-4">
            <ul class="space-y-1 px-2">
                ...
                <x-layouts.sidebar-two-level-link-parent title="Commerce & Support" icon="fas-headset"
                    ...
                    {{-- @endcan --}}
                    {{-- @can('newsletter.view') --}}
                    <x-layouts.sidebar-two-level-link href="{{ route('admin.newsletters.index') }}"
                        icon='fas-mail-bulk' :active="request()->routeIs('admin.newsletters*')">Newsletters</x-layouts.sidebar-two-level-link>
                    {{-- @endcan --}}

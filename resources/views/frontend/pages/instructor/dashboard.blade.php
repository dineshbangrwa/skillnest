                    ...
                    <div class="space-y-4">
                        ...
                        @if ($reviews->count())
                            @foreach ($reviews as $review)
                                <div class="flex items-start gap-3 p-3 hover:bg-gray-50 rounded transition">
                                    <div class="w-10 h-10 bg-amber-100 rounded flex items-center justify-center shrink-0">
                            ...
                            <div class="flex items-center gap-4 p-3 hover:bg-gray-50 rounded transition">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex items-center gap-3 mt-1 text-xs text-gray-600">
                                        ...
                                        <span>
                                            <i class="fas fa-rupee-sign mr-1"></i>{{ number_format($course->revenue) }}
                                        </span>
                                        <span>
                                            <i class="fas fa-star text-amber-500 mr-1"></i>
                                            {{ number_format($course->reviews_avg_rating, 1) ?? 'N/A' }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                        @empty
                            <p class="text-sm text-gray-500 text-center py-4">No published courses yet.</p>
                        @endforelse
                    </div>
                </div>
            </div>

            ...
            <div class="flex items-center gap-3 sm:gap-6">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" x-cloak
                        ...
                        <a href="{{ route('profile.index') }}" class="block px-4 py-2 text-sm hover:bg-gray-50">
    ...
    <div class="flex pt-14 sm:pt-16">
        ...
        <aside
            ...
            <nav class="p-3 sm:p-4">
                ...
                <a href="{{ route('instructor.courses') }}" @click="sidebarOpen = false"
                    class="flex items-center gap-3 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg hover:bg-gray-100 transition mb-1
                          {{ request()->routeIs('instructor.courses') ? 'bg-purple-50 text-purple-600 font-semibold' : 'text-gray-700' }}">

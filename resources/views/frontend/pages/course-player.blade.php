...
@section('content')
    <div style="background:var(--surface);">
        ...
        {{-- ── Top Navigation Bar ── --}}
        <div class="topbar sticky top-16 z-50">
            {{-- <div class="topbar"> --}}
                ...
                <div style="display:flex; align-items:center; justify-content:space-between; height:56px;">
                    ...
                    <div style="display:flex; align-items:center; gap:10px; flex-shrink:0;">
                        @if ($progressPercentage == 100)
                            <a href="{{ route('certificate.show', $course->slug) }}" class="btn-cert rounded">
                                <i class="fas fa-award"></i>
                                <span>Certificate</span>
                            </a>
                        @endif
                        <a href="{{ route('reviews.index', $course->id) }}" class="btn-primary rounded">
                    ...
                    <div
                        ...
                        <div style="flex:1; min-width:0;">
                            ...
                            <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
                                ...
                                <p style="color:var(--text);">{{ $currentLesson->formattedDuration }}</p>
                            </div>
                        </div>

                        {{-- Complete Button --}}
                        @if (!$lessonProgress || !$lessonProgress->is_completed)
                            <button onclick="markComplete()" id="complete-btn" class="btn-complete rounded">
                                <i class="fas fa-check-circle"></i>
                                <span>Mark Complete</span>
                            </button>
                        @else
                            <div class="badge-completed rounded">
                                <i class="fas fa-check-circle"></i>
                                <span>Completed</span>
                            </div>
                        @endif
                    ...
                    <form action="{{ route('discussion.store') }}" method="POST" style="margin-bottom:24px;">
                        ...
                        <div style="display:flex; flex-direction:column; gap:10px;">
                            ...
                            <textarea name="message" rows="3"
                                placeholder="Give us more detail — the more specific, the better the answers you'll get."
                                class="input-field  rounded"></textarea>
                            <div>
                        ...
                        <div class="discussion-card">
                            ...
                            <form action="{{ route('discussion.index') }}" method="POST"
                                ...
                                <input type="text" name="message" placeholder="Write a reply..."
                                    class="input-field rounded" style="flex:1; padding:8px 12px; font-size:13px;">
            ...
            <div id="curriculum-sidebar"
                ...
                <div style="padding:10px 8px; display:flex; flex-direction:column; gap:4px;">
                    @foreach ($course->sections()->get() as $section)
                        <div class="rounded"
                            style="background:var(--surface); overflow:hidden; border:1px solid var(--border);">

    ...
    <section class="py-16 sm:py-20 lg:py-24 bg-white" data-reveal>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                {{-- Contact Form --}}
                <div>
                    <h2 class="font-sora text-xl sm:text-3xl font-bold mb-2">Send us a message</h2>
                ...
                {{-- FAQ --}}
                <div>
                    <h2 class="font-sora text-xl sm:text-3xl font-bold mb-2">Frequently asked questions</h2>

            ...
            @if ($categories->isNotEmpty())
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                    ...
                    @foreach ($categories as $category)
                        ...
                        <div
                            class="bg-white rounded border border-gray-200 p-4 sm:p-6 hover:shadow-lg hover:border-purple-200 transition-all duration-200 flex flex-col justify-between">

                            {{-- Category Header --}}
                            <div class="flex items-center gap-3 mb-4">
                                <div
                                    class="w-10 h-10 sm:w-12 sm:h-12 rounded {{ $iconConfig['bg'] }} flex items-center justify-center shrink-0">
                                    @if ($category->icon)
            ...
            @else
                ...
                <div class="text-center py-20">
                    ...
                    <a href="{{ route('courses.search') }}"
                        class="inline-block mt-6 bg-purple-600 text-white font-semibold py-2 px-6 rounded hover:bg-purple-700 transition text-sm">
                        Browse All Courses
                    </a>
                </div>
            @endif
    ...
    <section class="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-purple-600 to-pink-600 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <a href="{{ route('courses.search') }}"
                    class="bg-white text-purple-600 hover:bg-gray-100 font-bold py-3 px-6 sm:px-8 rounded transition text-sm sm:text-base">
                    Browse All Courses
                </a>
                <a href="#"
                    class="bg-purple-800 hover:bg-purple-900 text-white font-bold py-3 px-6 sm:px-8 rounded transition border-2 border-purple-400 text-sm sm:text-base">
                    Contact Us
                </a>
            </div>
        </div>

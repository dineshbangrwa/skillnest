...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8 md:py-10">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div>
                <h1 class="font-sora text-xl sm:text-2xl font-bold">My Learning</h1>
        ...
        <div class="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white border border-gray-200 rounded p-5 sm:p-6">
                ...
                <p class="text-xs text-gray-400 text-center">Total learned this week: <span
                        class="text-purple-600 font-bold">
                        {{ $hoursLearned ?? 0 }}</span></p>
            </div>

            ...
            <div
                ...
                <div class="flex -space-x-2">
                    @foreach ($topInstructors as $instructor)
                        {{-- <img src="{{ $instructor->image ?? asset('default-avatar.png') }}" alt="{{ $instructor->initials() }}"
                            class="w-7 h-7 rounded-full border-2 border-purple-900 object-cover"> --}}
                        {{-- <div
                            class=" w-7 h-7 r border-2 border-purple-900 object-cover rounded-full items-center justify-center text-white bg-gradient-to-br from-sky-400 to-cyan-500">
                            {{ $instructor->initials() }}
                        </div> --}}
                    @endforeach
                </div>
                ...
                <div
                    ...
                    <svg class="w-4 h-4 xl:w-5 xl:h-5 text-amber-400" viewBox="0 0 24 24" fill="none"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M17 20h2a2 2 0 002-2V8a2 2 0 00-2-2h-2M9 4H7a2 2 0 00-2 2v12a2 2 0 002 2h2m4-16v16" />
                    </svg>
                </div>

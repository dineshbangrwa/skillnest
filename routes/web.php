...
use App\Http\Controllers\Frontend\Category\AllCategoryController;
...
use App\Http\Controllers\Frontend\Instructor\CourseInstructorController;
use App\Http\Controllers\Frontend\Instructor\DiscussionController;
...
Route::middleware(['auth', IsAdminMiddleware::class])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::resource('newsletters', AdminNewsletterController::class)->only(['index', 'show', 'destroy']);
...
// ====================Categories====================
Route::get('categories', [AllCategoryController::class, 'category'])->name('categories.index');
Route::get('category/{slug}', [AllCategoryController::class, 'categoryCourse'])->name('categories.show');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('buy/{course}/coupon', [BuyNowController::class, 'applyCoupon'])->name('buy.coupon.apply');
});
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('instructor/courses', [CourseInstructorController::class, 'courses'])->name('instructor.courses');
});
...
// ====================Discussion====================
Route::get('instructor/discussion', [DiscussionController::class, 'index'])->name('discussion.index');

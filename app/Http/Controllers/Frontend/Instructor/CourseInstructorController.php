...
class CourseInstructorController extends Controller
{
    ...
    public function index()
    {
        ...
        $reviews = Course::where('instructor_id', $instructorId)
            ->with(['reviews.user'])
            ->get()
        ...
        $topCourses = Course::where('instructor_id', $instructorId)
            ...
            ->map(function ($course) {
                ...
                $course->revenue = round($revenue * 0.80, 2);
    ...
    {
        $courses = Course::where('instructor_id', Auth::id())->withCount(['enrollments', 'reviews'])->with('media')->latest()->limit(10)->get();

        return view('frontend.pages.instructor.courses', compact('courses'));
    }
